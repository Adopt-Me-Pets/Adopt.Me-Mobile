...
import {
  ...
  CREATE_PASEADOR,
  GET_PASEADORES,
  MAIL_VERIFICAR_PASEADOR,
  GET_COUNTRIES,
  GET_PASEADORES_BY_ID,
  SET_USER,
  CLEAR_USER_DATA,
} from "../Actions";
...
export default function rootReducer(state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case GET_POST_ID:
      ...
      case GET_PASEADORES_BY_ID:
        return { ...state, paseadoresDetalles: action.payload };
    ...
    case "getDetallePaseadoresSinValidar":
      return {
        ...state,
        detallePaseadorSinValidar: action.payload,
      };
    ...
    case "postPaseador":
      ...
      case CREATE_PASEADOR:
        return { ...state };

      case GET_PASEADORES:
        return {
          ...state,
          paseadores: action.payload,
        };
      
      case MAIL_VERIFICAR_PASEADOR:
        return {
          ...state,
        }
